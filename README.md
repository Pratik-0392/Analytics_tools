...
🔹 This project is a basic Sales Management System developed using SQL. It includes the creation of four key tables: Customers, Products, Orders, and Order_Details. The database is populated with sample data to simulate a retail environment. Various SQL queries are used to extract insights, including inner/outer joins, subqueries, and aggregation functions. It also identifies top-selling products and high-value customers. This project demonstrates essential skills in relational database design and data analysis using SQL.
